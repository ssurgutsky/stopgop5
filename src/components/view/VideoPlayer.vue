<template>
  <div>
    <video playsinline="true" :style="styleObject1" autoplay="true" :loop="loop" ref="videoPlayer1" @canplay="onCanPlay" @ended="onEnd">
    </video>
    <video playsinline="true" :style="styleObject2" autoplay="true" :loop="loop" ref="videoPlayer2" @canplay="onCanPlay" @ended="onEnd">
    </video>
  </div>
</template>
